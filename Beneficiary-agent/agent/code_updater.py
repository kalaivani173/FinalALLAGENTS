...
def apply_code(manifest: dict) -> str:
    """Apply manifest change to Beneficiary Bank local repo. Returns patch content (also written to beneficiary.patch). No git required."""
