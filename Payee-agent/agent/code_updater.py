...
def apply_code(manifest: dict) -> str:
    """Apply manifest change to Payee PSP local repo. Returns patch content (also written to payee.patch). No git required."""
